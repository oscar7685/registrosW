...
<script type="text/javascript" language="JavaScript">
    $(document).ready(function() {
        ...
        $("#formCrearRegistro").validate({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: "/registrosW/Controlador?action=crearRegistro2",
                    data: $("#formCrearRegistro").serialize(),
                    success: function() {
                        location = "/registrosW/#listarRegistros";
                    } //fin success
                }); //fin $.ajax    
            }
        });
...
<div class="hero-unit">
    <div class="row">
        <div id="conte" class="span10">
            ...
            <form id="formCrearRegistro" class="form-horizontal" method="post">
                <fieldset>
